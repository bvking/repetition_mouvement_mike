/* autogenerated by Processing revision 1286 on 2023-07-16 */
...
public class repetition_mouvement_mikeOri extends PApplet {
...
//--------------------        method of interpolation to return the position of (rotation) by adding modulo
 ...
 public float scaleTheta(float theta) {
  while(theta < PI ) {
    theta += TWO_PI;
  }
  while(theta >= PI ) {
...
class SamplerTheta {
  ...
  SamplerTheta() {
   ...
   public void addSample(float theta) {  // add sample when bRecording
    int now = millis();
   ...
   public void beginPlaying() {
    ...
    if (samples.size() > 0) {
      ...
      for (int i = 0; i < samples.size() - 1; i++) {
        ...
        print( PApplet.parseInt (degrees( (samples.get(i).theta))));
        print(",");
        print(" good data x "  + PApplet.parseInt (degrees(samplesModified.get(i).theta))  + " looped " + numberOfrepetition + " "); // 3 eme ligne 2 eme vertical pas bn
...
SamplerTheta sampler;
 ...
 public void stopSampling() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--stop-color=#cccccc", "repetition_mouvement_mikeOri" };
    if (passedArgs != null) {
