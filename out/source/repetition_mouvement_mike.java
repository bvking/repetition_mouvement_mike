/* autogenerated by Processing revision 1286 on 2023-05-06 */
...
public class repetition_mouvement_mike extends PApplet {
...
//  text( " repeted  " +nf (movementInterpolated, 0, 2) , 10, 0);
 ...
 public void stopSampling() { 
  if (measure==20 && actualSec!=lastSec) {  
     textSize(100);
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--stop-color=#cccccc", "repetition_mouvement_mike" };
    if (passedArgs != null) {
